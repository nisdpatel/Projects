 ...
 * thus usilizes the adapter design pattern, similar to the Deque class defined
 * by the authors.
 *
 * @since 11/2/07
 ...
 * to create a type specific queue.  I add the extends qualifier to identify
 * the type parameter T as implementing Comparable.
 */

public class MyQueue<T extends Comparable> implements Queue<T> {
	/*
	 ...
	 */
	public DList<T> getList () {
		return list;
	}
	public void sort () {
		// get the list of this queue, and use the DList sort method
		getList ().sort ();		
	}  // end method sort
